...
MAX_RIST_BTNS = int(environ.get('MAX_RIST_BTNS', "10000"))
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\n Naitwa {bot},\n unaweza kuniunga na group lako nikatumika😂...')
BUTTON_LOCK_TEXT = environ.get("BUTTON_LOCK_TEXT", "⚠️ 𝙃𝙚𝙮 {query}! Hii sio yako tafadhari search yako hapo chini")
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', 'Lazima ulipie Tsh 1000 ndipo nikupatie movie 😂!')
...
SESSION_STRING = environ.get("SESSION_STRING", "https://t.me/+zNwwwkTbe7JkYTg0")
